...
var pathToAnimFiles = 'animation-files/';									// loads fine (files must be present on localhost)
...
var pathToOverlays = 'overlays/';													// loads fine (files must be present on localhost)
